...
import { SelectItem } from '../../src/presentation/components/common/SelectInput';
...
export default function SelectionScreenRoute() {
  ...
  useEffect(() => {
    if (selectionKey && (global as any).pendingSelections) {
      const data = (global as any).pendingSelections[selectionKey];
      if (data) {
