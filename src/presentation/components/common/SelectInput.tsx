...
export const SelectInput: React.FC<SelectInputProps> = ({
  ...
  const handlePress = () => {
    ...
    if (!(global as any).pendingSelections) {
      (global as any).pendingSelections = {};
    }
    
    (global as any).pendingSelections[selectionKey] = {
      ...
      onSelect: (selectedValue: string) => {
        ...
        // Clean up
        delete (global as any).pendingSelections[selectionKey];
      }
    };
